...
states_of_america[3]  # this takes the index 3 (Georgia)
states_of_america[-1]  # This takes the last one (Hawaii)

# Change the value of the index of the list
states_of_america[1] = "Pencilvania"

states_of_america.append("Disneyland")  # push a value at the end fo the list

states_of_america.extend(["Adding", "other", "Values"])
